...
execute if entity @e[type=item,nbt={Item:{id:"minecraft:apple",tag:{Grapes:1b}}},distance=..1] unless entity @s[tag=spirits.Grapes] run function spirits:ingredients/grapes
